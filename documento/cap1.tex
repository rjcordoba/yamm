...
definió originalmente su creador en [1]\footnote*{{\fpies Las indicaciones [{\it x}] hacen referencia a
...
demostración consiste en presentar \señalizaciones†una función recursiva escrita en \C/ que toma como
