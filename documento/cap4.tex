...
\encabezados{Operadores relacionales}
El resultado de las operaciones con operadores relacionales depende del orden de los operandos, en
este caso números naturales, según la ordenación habitual. Los operadores relacionales que
necesitamos usar se
el terminal «{\notermpars{natural}}» mediante la producción
que usar son «{\fcode=}», «{\fcode!=}», «{\fcode>}», «{\fcode<}», «{\fcode>=}», «{\fcode<=}» con el
significado conocido y explicado en [4].

\encaje
\begingroup\fgramat\noindent\alternativas ΩΦΨ\fin\hskip.3em→\hskip.3em\begingroup\alternativas{\notermpars{natural}}{\.\notermpars{ID}}{\:\notermpars{id}}\fin
\finencaje

\encabezados{Subprogramas}
