...
la posición 12 la suma de lo que hay en las posiciones 3 y 52.
...
\encaje
\begingroup\fgramat\alternativas ΩΦΨ\fin\hskip.3em→\hskip.3em\begingroup\alternativas{\notermpars{natural}}{\.\notermpars{id}}{\:\notermpars{id}}\fin
\finencaje
...
Las variables son nombres para referirnos a posiciones sin necesidad de saber qué posición
representará en el programa final.
