...
{\cmarcas=1 \macroins{\fcodenoterm x\kernpeq\marcas}{\fcodenoterm x} representa las cuatro
reglas:\hfil\break{\def\mk{\kern-.2em}\hbadness=10000\hbox to 3in{\hskip6.5pt\macroins{1\marcas\mk}{1}; \macroins{0\kernpeq\marcas\mk}{0};
\macroins{=\kernpeq\marcas\mk}{=}; \macroins{\estrella\marcas\mk}{\estrella}.}}}
...
el significado de las {\fcode Z}\kernpeq s es el explicado anteriormente. Así, la macro \hskip.1em«
\zeta{12} = \zeta{3} + \zeta{52}»\hskip.4em se traduciría por instrucciones que ponen en
la posición 12 la suma de lo que hay en las posiciones 3 y 52. En este punto conviene explicar el
otro significado que pueden tener las letras griegas que se han visto antes: además de números
pueden representar cadenas como «{\fcode.sum1}», que aparecería de forma «\zeta{.sum1}»\hskip.4em. 
