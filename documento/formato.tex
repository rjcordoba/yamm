...
%generales
\def\puntitos{\leaders\hbox to .7em{\hss.\hss}\hfill}
\def\entradaind#1#2{#1\puntitos#2\par}%\hbox to 1.8em{\hfil#2}

\def\entradaapend#1//#2..{\advance\cap by 1 \subcap=0 \vskip\dimen1 \parindent0pt \advance\count1 by 1
                         {\bf\char\count1 \ - \entradaind{#1}{#2}}}

\def\librosyotros#1//#2..{\vskip\dimen1{\bf\entradaind{#1}{#2}}}

\def\entradaindp#1//#2..{\advance\cap by 1 \subcap=0 \vskip\dimen1
                         \parindent0pt {\bf\leavevmode\hbox to 1.2em{\hfil\number\cap}.\kern.5em\entradaind{#1}{#2}}}

\def\entradainds#1//#2..{\advance\subcap by 1 \ssubcap=0
                         \parindent22pt\number\cap.\number\subcap.\kern.5em\entradaind{#1}{#2}}

\def\entradaindt#1//#2..{\parindent33pt \advance\ssubcap by 1
                         \number\cap.\number\subcap.\number\ssubcap.\kern.5em\entradaind{#1}{#2}}

\def\tragar#1{}
\def\encabezadop#1{\piecab=0 \advance\cap by 1\vfil\eject\noindent{\fencp \hskip1.8pt §\the\cap.\espenc #1}\vskip8pt
                   \subcap=0 \def\pie{\piecab=1 #1} \noindent
                   \write1{\string\entradaindp\space #1//\folio..}}

\def\encabezados#1{\global\advance\subcap by 1 \global\ssubcap=1 \vskip-\lastskip\penalty-100\vskip17pt plus5ptminus4pt
                   \noindent {\fencs\hskip5.2pt \the\cap.\the\subcap.\espenc\ #1}\vskip6pt plus.5pt\penalty100 \noindent
                   \write1{\string\entradainds\space #1//\folio..}}

\def\encabezadot#1{\vskip-\lastskip\penalty-100\vskip14pt\noindent{\fenct\hskip6.5pt
                   \the\cap.\the\subcap.\the\ssubcap.\espenc #1}\vskip7pt \advance\ssubcap by 1 \noindent
                   \write1{\string\entradaindt\space #1//\folio..}}
...
\def\listraducciones{\inilista{0pt}{21pt}{\lower.75ex\hbox{\fsimbols⬝}\kern4pt}\parskip22pt\vskip-5pt}
...
\def\pagblanca{\hbox{}\vfil\footline{}\eject}
\def\appendix#1{\vfil\eject \ifodd\pageno\else\pagblanca\fi \hbox{}\vskip2.95in\footline{}\advance\count1 by 1 \piecab=0%\toks1=\footline
                ...
                \def\pie{Apéndice \char\count1 \kern.15em-\kern.2em #1}\footline=\líneapie \piecab=1}%\write1{\string\entradaapend\space #1//\folio..}
...
\def\ponpdf#1{\pagspdf=\XeTeXpdfpagecount#1 \pagsc=0 \def\nombre/{#1}
                 \ponerpdfpag}
\def\ponerpdf#1+{\ponpdf{pdfs/#1.pdf}}
\def\ponermacro{\ifnum\macrosc<\nummacros \advance\macrosc by 1
                      \edef\nompdf{macros/macros\number\macrosc} \expandafter\ponerpdf\nompdf+ \let\bucle=\ponermacro
                \else\let\bucle=\relax\fi \bucle}
\def\ponermacros{\nummacros=17 \macrosc=0 \ponermacro}
\def\ponercapítulo{\ifnum\macrosc<\nummacros \advance\macrosc by 1
                         \input capítulos/cap\number\macrosc \let\bucle=\ponercapítulo
                   \else\let\bucle=\relax\fi\bucle}
\def\ponercapítulos{\nummacros=6 \macrosc=0 \ponercapítulo}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def\piepag{\ifodd\pageno \hfill \pie \hskip8pt {\fnumpag\folio}\kern-8pt
            \else \kern-8pt {\fnumpag\folio}\hskip8pt \pie \hfill\fi}
...
\footline={\ffoot\vbox to 42pt{} \piepag}
\líneapie=\footline
