...
\dimen1=6pt
\indexsecc{Apéndices}
\entradaapend Especificación de {\fcode C-\kern -.12em-}//33..
\entradaapend Máquina universal de Turing para programas {\fcode C-\kern -.12em-}//37..
\entradaapend Ejemplo de máquina de Turing en {\fcode C}//45..
\entradaapend Función recursiva ejecutora de programas {\fcode C-\kern -.12em-}//49..
\entradaapend Macroinstrucciones de {\fcode C-\kern -.12em-}//79..
\indexsecc{Libros y otros recursos}
\librosyotros Bibliografía//155..
\librosyotros Recursos//156..
\endgroup
\cap=0
